...
INSERT INTO [pq].[CalendarStage]  ([SortOrder],[Name],[StageType])  VALUES  (3,'In Service', 3)
...
SELECT ServiceId, (SELECT TOP 1 ID FROM pq.[CalendarStage] WHERE StageType =3) from qf.Service          
